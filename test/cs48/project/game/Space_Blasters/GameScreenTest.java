...
/* 
try { 
   Method method = GameScreen.getClass().getMethod("start"); 
...
/* 
try { 
   Method method = GameScreen.getClass().getMethod("stop"); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
...
/* 
try { 
   Method method = GameScreen.getClass().getMethod("updateInternalBuffers"); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
